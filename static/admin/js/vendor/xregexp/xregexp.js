...
var REGEX_DATA = 'xregexp'; // Optional feature that can be installed and uninstalled
...
/**
 * Installs optional feature according to the specified options. Can be undone using
 * `XRegExp.uninstall`.
 *
 * @memberOf XRegExp
...
/**
 * Uninstalls optional feature according to the specified options. Used to undo the actions of
 * `XRegExp.install`.
 *
 * @memberOf XRegExp
 * @param {Object|String} options Options object or string.
